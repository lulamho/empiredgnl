...
import svgPaths from "../../imports/SanhChungTaoTin/svg-l2tz67j24p";
  ...
  return (
    <div className="bg-black overflow-clip relative size-full">
      ...
      <div className="absolute h-[699px] left-0 top-[48px] w-[393px]">
        ...
        <div className="absolute content-stretch flex items-center justify-center left-0 p-[16px] top-[50px] w-[393px]">
          ...
          <input
            ...
            className="font-semibold leading-[40px] text-[32px] text-white text-center tracking-[-0.2px] bg-transparent outline-none placeholder:text-white/60"
            autoFocus
          />
        </div>
      ...
      <div className="absolute content-stretch flex items-center justify-between left-0 px-[8px] top-[769px] w-[393px]">
        ...
        <button
          className={`bg-white content-stretch flex gap-[4px] items-center justify-center px-[16px] py-[8px] relative rounded-[12px] shrink-0 cursor-pointer active:opacity-70 ${!text.trim() ? 'opacity-50' : ''}`}
          onClick={() => {
            if (text.trim()) {
              navigate('/create-story/preview', { state: { text } });
            }
          }}
        >
