import svgPaths from "./svg-po6a7divj0";
import imgCoverPhoto from "./ffa43fd071fcd412e7eafd756fa5915bc9343f68.png";
import imgProfilePicture from "./c44a03a418d306a3b3808b67082dd71dafac629a.png";
import imgProfilePicture1 from "./e9ba9e4edf0d98edbcedc4b43ea36d151371ddd1.png";
...
function IconL() {
  return (
    <div className="bg-[rgba(0,0,0,0.5)] content-stretch flex items-center justify-center p-[6px] relative rounded-[100px] shrink-0" data-name="Icon L">
      <div className="overflow-clip relative shrink-0 size-[20px]" data-name="Arrow Back">
        <div className="absolute inset-[9.78%_27.42%_9.78%_26.44%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 9.2275 16.0896">
            <path d={svgPaths.p3f6c0200} fill="var(--fill-0, white)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
