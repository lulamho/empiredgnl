import svgPaths from "./svg-dcgei3nd2t";
...
import imgProfilePicture6 from "./e9ba9e4edf0d98edbcedc4b43ea36d151371ddd1.png";
    ...
    <div className="relative shrink-0 w-full" data-name="Post">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[#171717] text-[14px]">Đây là bài viết nhóm. Viết cái gì thì sẽ hiển thị ở đây và bên ngoài sảnh chung.</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[8px] relative size-full">
          <div className="relative shrink-0 size-[40px]" data-name="Profile Picture">
            <img alt="" className="absolute block inset-0 max-w-none size-full" height="40" src={imgProfilePicture6} width="40" />
          </div>
          <Frame12 />
        </div>
      </div>
...
function Container() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-0 top-[98px] w-[393px]" data-name="Container">
      <Hero />
      <Post />
      <Main />
    </div>
...
export default function NhomChiTiet() {
  return (
    <div className="bg-[#f5f5f5] overflow-clip relative rounded-[24px] size-full" data-name="[Nhom] Chi Tiet">
      <Container />
