import svgPaths from "./svg-tlhjouk0ll";
...
import imgImg from "./fd2ab8178b1595a0d53b3d94a27255b5601b6aeb.png";
...
function MobileNav() {
  return (
    <div className="absolute bg-white h-[48px] left-0 top-[50px] w-[393px]" data-name="Mobile Nav">
      ...
      <div className="-translate-y-1/2 absolute bg-[#f99d0d] content-stretch flex gap-[4px] items-center justify-center px-[16px] py-[4px] right-[8px] rounded-[8px] top-1/2" data-name="Button">
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[20px] not-italic relative shrink-0 text-[#171717] text-[14px] w-[294px]">Mình muốn hỏi về bài tập trong file đính kèm</p>
...
function Group() {
  return (
    <div className="absolute inset-[5.56%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
        <g id="Group">
          <path d={svgPaths.p231eb980} fill="var(--fill-0, #171717)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function CircleXmark() {
  return (
    <div className="absolute bg-white inset-[-16.07%_-16.07%_83.93%_83.93%] overflow-clip rounded-[100px]" data-name="circle-xmark 1">
      <Group />
    </div>
  );
}
...
function Image() {
  return (
    <div className="relative rounded-[12px] shrink-0 size-[56px]" data-name="Image">
      <div className="absolute inset-0 pointer-events-none rounded-[4px]" data-name="img">
        <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[4px] size-full" src={imgImg} />
        <div aria-hidden="true" className="absolute border border-[#1e69f3] border-solid inset-0 rounded-[4px]" />
      </div>
      <CircleXmark />
    </div>
  );
...
function Image1() {
  return (
    <div className="relative rounded-[2px] shrink-0 size-[48px]" data-name="Image">
      <div className="absolute bg-[#e8f0fe] inset-0 rounded-[2px]" data-name="img" />
      <div className="absolute inset-1/4 overflow-clip" data-name="Docs">
        <div className="absolute inset-[10.42%_18.75%]" data-name="Vector">
          <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 19">
...
function Frame4() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start not-italic relative shrink-0 w-[87px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-black w-full">Filename.pdf</p>
...
function CircleXmark1() {
  return (
    <div className="absolute bg-white overflow-clip right-[-8px] rounded-[100px] size-[18px] top-[-8px]" data-name="circle-xmark 1">
      <Group1 />
    </div>
  );
}
...
function Frame5() {
  return (
    <div className="content-stretch flex gap-[12px] items-center max-w-[180px] pl-[4px] pr-[12px] py-[4px] relative rounded-[4px] shrink-0 w-[180px]">
      <div aria-hidden="true" className="absolute border border-[#1e69f3] border-solid inset-0 pointer-events-none rounded-[4px]" />
      <Image1 />
      <Frame4 />
      <CircleXmark1 />
    </div>
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex gap-[12px] items-center left-0 p-[8px] top-[457px] w-[393px]">
      <Image />
      <Frame5 />
    </div>
  );
...
export default function NhomDangVietChiaSe() {
  return (
    <div className="bg-[#f5f5f5] overflow-clip relative rounded-[24px] size-full" data-name="[Nhom] Dang Viet Chia Se">
