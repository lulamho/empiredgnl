import svgPaths from "./svg-4jgfcimqp7";
...
function Image() {
  return (
    <div className="overflow-clip relative rounded-[2px] shrink-0 size-[48px]" data-name="Image">
  ...
  return (
    <div className="absolute inset-[5.56%]" data-name="Group">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 21.3333 21.3333">
        <g id="Group">
          <path d={svgPaths.p3d530e00} fill="var(--fill-0, #171717)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function CircleXmark() {
  return (
    <div className="bg-white overflow-clip relative rounded-[133.333px] shrink-0 size-[24px]" data-name="circle-xmark 1">
      <Group />
    </div>
  );
}
  ...
  return (
    <div className="relative rounded-[4px] shrink-0 w-full">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[12px] items-center pl-[4px] pr-[12px] py-[4px] relative size-full">
          <Image />
          <Frame1 />
          <CircleXmark />
        </div>
...
function Text() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="text">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[16px] whitespace-nowrap">{`Bộ đề ôn thi HSA 2024 `}</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="text">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic relative shrink-0 text-[#171717] text-[16px] whitespace-nowrap">HSA, ôn thi 2026...</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="text">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[24px] min-w-px not-italic relative text-[#171717] text-[16px]">Mọi người xem qua tài liệu này nhé!!!</p>
    </div>
  );
}
...
function Label4() {
  return (
    <div className="relative shrink-0 w-full" data-name="Label">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center px-[12px] py-[2px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[16px] min-w-px not-italic relative text-[#737373] text-[12px] text-right">65/500</p>
        </div>
      </div>
    </div>
  );
...
export default function NhomChiaSeTaiLieuXong() {
  return (
    <div className="bg-[#f5f5f5] overflow-clip relative rounded-[24px] size-full" data-name="[Nhom] Chia se tai lieu xong">
