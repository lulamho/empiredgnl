import svgPaths from "./svg-0gvss8tc2g";
...
import imgVideoImage from "./fd2ab8178b1595a0d53b3d94a27255b5601b6aeb.png";
import imgProfilePicture5 from "./e9ba9e4edf0d98edbcedc4b43ea36d151371ddd1.png";
import imgVideoImage1 from "./5052b7b5112fb64b5f487cb959038bf783018ef9.png";
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center py-[4px] relative shrink-0 w-full">
      ...
      <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[50px]" data-name="Chat Box">
        <div aria-hidden="true" className="absolute border border-[#e5e5e5] border-solid inset-0 pointer-events-none rounded-[50px]" />
        <div className="flex flex-row items-center size-full">
    ...
    <div className="relative shrink-0 w-full" data-name="Post">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center p-[8px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-px not-italic relative text-[#171717] text-[14px]">Mình muốn hỏi về bài tập trong file đính kèm</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-[393px]" data-name="Mobile Post">
        ...
        <div className="aspect-[447/252] relative shrink-0 w-full" data-name="video-image">
          <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
            ...
            <img alt="" className="absolute max-w-none object-cover size-full" src={imgVideoImage1} />
          </div>
        </div>
        <Frame13 />
      </div>
...
export default function NhomPostChiaSe() {
  return (
    <div className="bg-[#f5f5f5] overflow-clip relative rounded-[24px] size-full" data-name="[Nhom] Post Chia Se">
      <Container />
